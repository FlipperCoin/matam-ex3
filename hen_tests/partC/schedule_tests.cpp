...
void staffTests() {
	...
	compare_file_to_buffer(buf, "../hen_tests/outputs/partC_test1.txt");
    schedule.printEventDetails(mtm::DateWrap(27, 12, 2020), "Publish Test");
	compare_file_to_buffer(buf, "../hen_tests/outputs/partC_test2.txt");
    schedule.printEventDetails(mtm::DateWrap(5, 1, 2021), "Update Q&A");
	compare_file_to_buffer(buf, "../hen_tests/outputs/partC_test3.txt");
	schedule.printMonthEvents(12, 2020);
	compare_file_to_buffer(buf, "../hen_tests/outputs/partC_test4.txt");
	...
	compare_file_to_buffer(buf, "../hen_tests/outputs/partC_test5.txt");
}
...
void bigTest() {
	...
	s->printAllEvents();
	compare_file_to_buffer(buf, "../hen_tests/outputs/partC_test6.txt");
	s->printMonthEvents(1, 2019);
	compare_file_to_buffer(buf, "../hen_tests/outputs/partC_test7.txt");
	s->printMonthEvents(7, 2020);
	compare_file_to_buffer(buf, "../hen_tests/outputs/partC_test8.txt");

	s->printSomeEvents(predicateNameS, true);
	compare_file_to_buffer(buf, "../hen_tests/outputs/partC_test9.txt");

	s->printSomeEvents(predicateNameS, false);
	compare_file_to_buffer(buf, "../hen_tests/outputs/partC_test10.txt");

	s->printEventDetails(DateWrap(15, 3, 2020), "Static&Ben el");
	compare_file_to_buffer(buf, "../hen_tests/outputs/partC_test11.txt");
